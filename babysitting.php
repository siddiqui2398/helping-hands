    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>Have some time for yourself without worrying about your kids</h3>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/babysitting.jpg" alt="Office" />
                    <h4 class="services_h4">24 Hours Nanny</h4>
                    <p>Rs. 35000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/babysitting.jpg" alt="Carpet" />
                    <h4 class="services_h4">Baby Sitter</h4>
                    <p>Rs. 1000 per 3 hours</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
            </div>
