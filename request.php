...
<html lang="en">
    ...
    <head>
        ...
        <title>
            Helping Hands For You | Experts in Serving Your Needs
        </title>
        ...
        <div id="main">
            ...
            <div class="main_contact">
                <div class="contact_heading">
                    <h2 class="contact_h2">Request Service</h2>
                    <p>
                ...
                <div class="contact_form">
                    <form method = "post" action="app.php">
                        ...
                        <input type="text" name ="serviceName" value = "<?php echo $_COOKIE['serviceInfo'];?>" readonly required/><br />
                        <textarea
                            type="text"
                            placeholder=" Message..."
