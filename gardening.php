    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>Lawn Maintenance is a Must</h3>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/gardening.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Gardening</h4>
                    <p>Rs. 22000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/gardening.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Gardening</h4>
                    <p>Rs. 740 per day</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
            </div>
