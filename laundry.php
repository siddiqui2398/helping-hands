    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>We Are Cleaning Experts</h3>
                <p>
                    We have 10 years of cleaning experience. See what we can do
                    below.
                </p>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/laundry.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Laundry(Including Iron Pressing)</h4>
                    <p>Rs. 20000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/laundry.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Laundry(Including Iron Pressing)</h4>
