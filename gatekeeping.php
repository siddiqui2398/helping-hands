    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>A little help in recieving your guests</h3>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/gatekeeper.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Gatekeeper</h4>
                    <p>Rs. 20000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/gatekeeper.jpg" alt="Carpet" />
                    <h4 class="services_h4">Daily Gatekeeper(24 hours)</h4>
                    <p>Rs. 5000 per day</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
            </div>
