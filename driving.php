    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>Can't Drive? No Issue at all</h3>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/driving.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Driving Services(Without Car)</h4>
                    <p>Rs. 17000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/driving.jpg" alt="Carpet" />
                    <h4 class="services_h4">Daily Driving Services(Without Car)</h4>
                    <p>Rs. 1000 per day for 3 hours</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
            </div>
        </div>
