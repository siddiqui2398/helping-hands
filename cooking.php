        ...
        <div id="main">
            ...
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/kitchen.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Kitchen Helper</h4>
                    <p>Rs. 17000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/kitchen.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Kitchen Helper</h4>
                    <p>Rs. 570 per day</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>

                <div class="services_content">
                    <img src="img/pakistanicuisine.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Chef(Pakistani Cuisine)</h4>
                    <p>Rs. 17000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/pakistanicuisine.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Chef(Pakistani Cuisine)</h4>
                    <p>Subject to number of dishes and people</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>

                <div class="services_content">
                    <img src="img/cuisines.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Chef(Variety of cuisines)</h4>
                    <p>Rs. 50000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/cuisines.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Chef(Variety of cuisines)</h4>
                    <p>Subject to number of dishes and people</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
