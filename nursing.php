    ...
    <body>
        ...
        <div id="main">
            <div class="main_heading">
                <h3>Care For Your Elders</h3>
            </div>
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/nursing.jpg" alt="Office" />
                    <h4 class="services_h4">Monthly Nursing for Aged Person</h4>
                    <p>Rs. 30000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/nursing.jpg" alt="Office" />
                    <h4 class="services_h4">Daily Nursing for Aged Person</h4>
