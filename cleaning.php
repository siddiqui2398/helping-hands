        ...
        <div id="main">
            ...
            <div class="main_grid">
                <div class="services_content">
                    <img src="img/service1.jpeg" alt="Office" />
                    <h4 class="services_h4">Monthly Cleaner</h4>
                    <p>Rs. 25000 per month</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
                <div class="services_content">
                    <img src="img/service1.jpeg" alt="Carpet" />
                    <h4 class="services_h4">Daily Cleaner</h4>
                    <p>Rs. 830 per day</p>
                    <a href="request.php"><button class="request">Request</button></a>
                </div>
            </div>
